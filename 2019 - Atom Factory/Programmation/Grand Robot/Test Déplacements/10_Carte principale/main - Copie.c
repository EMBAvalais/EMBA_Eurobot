...
*/
	...
	driver_Servo_Angle(0xC4, 180, 95, 1); //En position ouverte
	driver_Servo_Angle(0xC4, 180, 140, 2); //En position ouverte
	driver_Servo_Angle(0xC4, 180, 10, 3); //Initialisation en position ferm�
	driver_Servo_Angle(0xC4, 180, 150, 4); //Initialisation en position ferm�
	driver_Servo_Angle(0xC4, 180, 160, 5); //Initialisation en position ferm�
	
	_LED3 = 0;


//	Affichage_Score(0x70, 100);
	delay_ms(2000);
//	Affichage_Score(0x70, 0);
...
//==============================================================================================================================
			...
			switch(Etat_prog_gauche)//côte gauche (violet)
			{
				...
				__Check_commande_atteint();                  //fonction qui check si le déplacement à été effectué
	              if(flag_depl_ok == 1)                     //si le déplacement est fini
	              {
                  __Tourne_sur_place(-90,5000);                     //Fonction pour faire avancer le robot     
              ...
              case action3_avance8 :
				__Check_commande_atteint();                  //fonction qui check si le déplacement à été effectué
	              ...
	              {
					_Tim3On=1;
                  __Recule(1500000,2000);                     //Fonction pour faire avancer le robot
