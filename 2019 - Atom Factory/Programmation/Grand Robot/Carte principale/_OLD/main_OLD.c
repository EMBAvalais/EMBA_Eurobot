...
//int1 HasBegun = 0;				// Permet de savoir si le jeu à démarrer
int1 ToDisplay=0;
...
//	delay_ms(1300); 
	...
	delay_ms(100);
		...
		//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		// Set la base
		// On n'affiche pas l'erreur ici car si on débranche le driver de déplacement
		// pour envoyer les objectifs, cela bloquerait le système
